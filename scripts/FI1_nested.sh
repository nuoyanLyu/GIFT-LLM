...
LOCAL_PATH="/root/autodl-tmp/mn-comp-7b"
LOG_DIR="/root/RAGEN/logs/mn-comp-7b"
...
WANDB_MODE=offline RAY_DEDUP_LOGS=0 python train.py --config-name _15_FI1_nested \
 ...
 trainer.experiment_name=mn-comp-7b \
