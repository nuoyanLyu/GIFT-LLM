...
LOCAL_PATH="/root/autodl-tmp/all-mix-7b"
LOG_DIR="/root/RAGEN/logs/all-mix-7b"
...
WANDB_MODE=offline RAY_DEDUP_LOGS=0 python train.py --config-name _20_FI3_mix \
 ...
 trainer.experiment_name=all-mix-7b \
