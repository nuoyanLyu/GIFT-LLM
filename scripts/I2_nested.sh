...
LOCAL_PATH="/root/autodl-tmp/nt-comp"
LOG_DIR="/root/RAGEN/logs/nt-comp"
...
WANDB_MODE=offline RAY_DEDUP_LOGS=0 python train.py --config-name _24_I2_nested \
 ...
 trainer.experiment_name=nt-comp0 \
