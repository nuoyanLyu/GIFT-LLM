...
LOCAL_PATH="/data1/lvnuoyan/llm_model/gift/nt-batch"
LOG_DIR="/home/lvnuoyan/RAGEN/logs/nt-batch"
...
WANDB_MODE=offline RAY_DEDUP_LOGS=0 python train.py --config-name _28_nt_batch \
 system.CUDA_VISIBLE_DEVICES=\"4\" \
 ...
 trainer.experiment_name=nt-batch \
