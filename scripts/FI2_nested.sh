...
LOCAL_PATH="/root/autodl-tmp/mnt-comp0-7b"
LOG_DIR="/root/RAGEN/logs/mnt-comp0-7b"
...
WANDB_MODE=offline RAY_DEDUP_LOGS=0 python train.py --config-name _21_FI2_nested \
 ...
 trainer.experiment_name=MNT-comp0-7b \
