...
LOCAL_PATH="/data1/lvnuoyan/llm_model/gift/mnt_batch0"
LOG_DIR="/home/lvnuoyan/RAGEN/logs/mnt_batch0"
...
WANDB_MODE=offline RAY_DEDUP_LOGS=0 python train.py --config-name _26_mnt_batch \
 system.CUDA_VISIBLE_DEVICES=\"5\" \
 ...
 trainer.experiment_name=mnt-batch0 \
