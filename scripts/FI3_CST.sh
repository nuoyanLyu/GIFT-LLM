...
LOCAL_PATH="/data1/lvnuoyan/llm_model/gift/all_batch2"
LOG_DIR="/home/lvnuoyan/RAGEN/logs/all_batch2"
...
WANDB_MODE=offline RAY_DEDUP_LOGS=0 python train.py --config-name _27_all_batch \
 ...
 trainer.experiment_name=all-batch2 \
